        ...
        {reportList.length > 0 &&
          reportList.map((report, index) =>
            <View key={report._id}>
              ...
              />
              {/* {!report.unfollow ? <ReportItem item={report} navigation={navigation} reportMergeState={reportMergeState} onRemove={onRemove} statusSource={StatusSource.reportA} /> : <Text></Text>} */}
